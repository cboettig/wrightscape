...
in a subclade following a potential innovation. This would predict and increase
in the rate disparity increases in some focal traits in the subclade relative
to the base rate observed.  We will refer to this model in which the strength
of stablizing selection decreases as the release of constraint model.
...
without no central tendancy imposed by the constraint in the OU model.  If the
...
in @Boettiger2012 which uses a bootstrap simulation approach to compare likehood
