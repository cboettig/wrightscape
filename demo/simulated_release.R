...
plot(poste_theta2, xlab="theta", main="Optimum", xlim=xlim, ylim=ylim, cex=2, cex.lab=2, cex.main=2, cex.axis=2)
...
plot(poste_sigma2, xlab="sigma", main="Diversification rate", xlim=xlim, ylim=ylim, cex=2, cex.lab=2, cex.main=2, cex.axis=2)
